...
angular.module('app.admin.services.Staff', [])
  .factory('StaffService', ($http, Configure) => {
     ...
     return {
       list(limit, offset) {
         let _url = `${url}/admin/staff/list`;
         return $http.post(_url, {limit: limit, offset: offset});
       },

       total() {
         let _url = `${url}/admin/staff/total`;
         return $http.post(_url);
       },

       save(staff) {
         let _url = `${url}/admin/staff`;
       ...
       detail(staffId) {
         let _url = `${url}/admin/staff/detail/${staffId}`;
         return $http.get(_url);
       },

       search(query) {
         let _url = `${url}/admin/staff/search`;
         return $http.post(_url, {query: query});
       },

       changePassword(staffId, password) {
         let _url = `${url}/admin/staff/changepass`;
         return $http.post(_url, { staffId: staffId, password: password });
       },

       remove(staffId) {
         let _url = `${url}/admin/staff/${staffId}`;
