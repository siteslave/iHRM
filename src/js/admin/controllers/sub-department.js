...
angular.module('app.admin.controllers.SubDepartment', [
  'app.admin.services.SubDepartment',
  'app.admin.services.Department',
  'app.admin.controllers.dialogs.SubDepartment',
  'app.admin.controllers.dialogs.SubDepartmentUpdate'
])
