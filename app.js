...
let carLicense = require('./routes/admin/car-license');
...
let worksRoute = require('./routes/admin/works');
...
app.use('/admin/car-license', userAuth, isAdmin, carLicense);
...
app.use('/admin/works', userAuth, isAdmin, worksRoute);
